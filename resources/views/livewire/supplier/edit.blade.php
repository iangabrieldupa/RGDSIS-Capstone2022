<div>
    ...
    <div class="intro-y box p-5">
        ...
        <div class="text-right mt-5">
            <button type="button" href="{{ url('/supplier') }}" class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
            <button class="btn btn-primary w-24" wire:click='updateSupplier'>Update Supplier</button>
        </div>
    </div>
    <!-- END: Form Layout -->
</div>
